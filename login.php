<?php
	...
	if(isset($_POST['proses'])){
		...
		if($jum > 0){
			...
			echo '<script>alert("Maaf Login Tidak Berhasil");history.go(-1);</script>';
		}
	}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Login - HIJABEST BY Marista</title>
                    ...
                    <div class="card-body p-0">
						...
						<div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4"><b>Login HIJABEST BY Marista</b></h4>
							</div>
